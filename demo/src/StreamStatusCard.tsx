...
import { useClaimableCounter } from "./useClaimableCounter";
...
export function StreamStatusCard({
  ...
  // Use the live-updating claimable counter hook
  const liveClaimable = useClaimableCounter(stream, claimable);
